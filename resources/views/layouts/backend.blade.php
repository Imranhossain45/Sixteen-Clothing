      ...
      @if (Auth::user()->user_type == 1)
        ...
        <li class="nav-item">
          ...
          <div id="collapseProduct" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="{{ route('backend.product.create') }}">Add Product</a>
              <a class="collapse-item" href="{{ route('backend.product.index') }}">All Product</a>
            </div>
          </div>
        </li>
        <!-- Product end -->
        ...
        <li class="nav-item">
          ...
          <div id="collapseCake_pastry" class="collapse" aria-labelledby="headingPages"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="">Add Cake_pastry</a>
              <a class="collapse-item" href="">All Cake_pastry</a>
            </div>
          </div>
        </li>
        <!-- Cake_pastry end -->
        ...
        <li class="nav-item">
          ...
          <div id="collapseCoupon" class="collapse" aria-labelledby="headingPages"
            data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <a class="collapse-item" href="">All Coupon</a>
            </div>
          </div>
        </li>
        <!-- Coupon end -->
        ...
        <li class="nav-item">
          ...
          <div id="collapseShipping_Charge" class="collapse" aria-labelledby="headingPages"
            data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <a class="collapse-item" href="">All Shipping Charge</a>
            </div>
          </div>
        </li>
        <!-- Shipping Charge end -->
